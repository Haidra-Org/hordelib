...
def generate_images_txt2img():
    ...
    pil_image = horde.basic_inference(data)
    pil_image.save(
        f"images/stresstest/cnet_{model}_{sampler}_{threading.current_thread().ident}_{i}.webp",
        quality=80,
    )
...
def generate_images_pp():
    ...
    pil_image.save(
        f"images/stresstest/pp_{model}_{threading.current_thread().ident}_{i}.webp",
        quality=80,
    )
