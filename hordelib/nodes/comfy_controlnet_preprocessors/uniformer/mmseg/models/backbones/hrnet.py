...
from hordelib.nodes.comfy_controlnet_preprocessors.uniformer.mmcv.utils.parrots_wrapper import _BatchNorm

from hordelib.nodes.comfy_controlnet_preprocessors.uniformer.mmseg.ops import Upsample, resize
...
class HRNet(nn.Module):
    ...
    Example:
        >>> from hordelib.nodes.comfy_controlnet_preprocessors.uniformer.mmseg.models import HRNet
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
