...
## [Unreleased](https://github.com/jug-dev/hordelib/tree/HEAD)

[Full Changelog](https://github.com/jug-dev/hordelib/compare/v0.5.6...HEAD)

**Merged pull requests:**

- tests: class scope on inference tests for speedup [\#78](https://github.com/jug-dev/hordelib/pull/78) ([db0](https://github.com/db0))
- build: detect release mode or dev mode [\#76](https://github.com/jug-dev/hordelib/pull/76) ([jug-dev](https://github.com/jug-dev))
- refactor!: Second big Model Manager rework step [\#75](https://github.com/jug-dev/hordelib/pull/75) ([tazlin](https://github.com/tazlin))
- fix: adjust mlsd annotator defaults [\#74](https://github.com/jug-dev/hordelib/pull/74) ([jug-dev](https://github.com/jug-dev))
